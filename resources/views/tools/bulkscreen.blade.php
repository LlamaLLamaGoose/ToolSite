    ...
    <div class="flex">
        <div class="ml-4 w-full mr-8">
            <form method="POST" action="/tools/bulkscreen/check">
                ...
                <textarea class="rounded bg-gray-700 placeholder-gray-400 w-full pl-2 pt-2 text-gray-200 text-xs" name="syncCommandsTXT" rows="12" placeholder="@include('components/tools/_example_bulkscreen')"></textarea><br />
                ...
                <textarea class="rounded bg-gray-700 placeholder-gray-400 w-full pl-2 pt-2 text-gray-200 text-xs" name="output" id="output" rows="20" placeholder="Bulk Screens">@if(!empty($results)){{ implode($results['screenS']) }}
